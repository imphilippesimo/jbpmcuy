...
public class DocumentResourceIntTest {
    ...
    private static final String DEFAULT_DOC_REF = "AAAAAAAAAA";
    private static final String UPDATED_DOC_REF = "BBBBBBBBBB";

    private static final Boolean DEFAULT_TREATED = false;
    private static final Boolean UPDATED_TREATED = true;
    ...
    public void createDocument() throws Exception {
        ...
        assertThat(testDocument.getDocRef()).isEqualTo(DEFAULT_DOC_REF);
        assertThat(testDocument.isTreated()).isEqualTo(DEFAULT_TREATED);
        assertThat(testDocument.isValidated()).isEqualTo(DEFAULT_VALIDATED);
    }
    ...
    @Test
    @Transactional
    public void checkDocRefIsRequired() throws Exception {
        int databaseSizeBeforeTest = documentRepository.findAll().size();
        // set the field null
        document.setDocRef(null);
    ...
    public void getAllDocuments() throws Exception {
        ...
        restDocumentMockMvc.perform(get("/api/documents?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].docRef").value(hasItem(DEFAULT_DOC_REF.toString())))
            .andExpect(jsonPath("$.[*].treated").value(hasItem(DEFAULT_TREATED.booleanValue())))
    ...
    public void getDocument() throws Exception {
        ...
        restDocumentMockMvc.perform(get("/api/documents/{id}", document.getId()))
            ...
            .andExpect(jsonPath("$.docRef").value(DEFAULT_DOC_REF.toString()))
            .andExpect(jsonPath("$.treated").value(DEFAULT_TREATED.booleanValue()))
    ...
    public void updateDocument() throws Exception {
        ...
        Document testDocument = documentList.get(documentList.size() - 1);
        assertThat(testDocument.getDocRef()).isEqualTo(UPDATED_DOC_REF);
        assertThat(testDocument.isTreated()).isEqualTo(UPDATED_TREATED);
        assertThat(testDocument.isValidated()).isEqualTo(UPDATED_VALIDATED);
    }
